...
to the residual cumulative displacement time-series (`cum`) of SBOI
generated by LiCSBAS. The aim is to convert the relative SBOI time series into an absolute reference frame.
...
This will:
 ...
 - Interpolate `daz` to match the time steps of the SBOI time-series cube
